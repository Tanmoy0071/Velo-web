...
import { VELO_CHAT_PROMPT, VELO_INTENT_PROMPT, WEB_ANALYSIS_PROMPT, WEB_GENERATION_PROMPT } from "@/lib/prompt";
...
- Context from previous pages : ${previousPagesContext}
  ...
  const summaryResult = await insforge.ai.chat.completions.create({
    ...
    messages: [
      {
        role: "system",
        content: `You are Velo, an AI web design agent. You just finished building pages.
